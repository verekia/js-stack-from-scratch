...
Next section: [05 - Redux, Immutable, Fetch](/tutorial/05-redux-immutable-fetch#readme)

Back to the [previous section](/tutorial/03-express-nodemon-pm2#readme) or the [table of contents](https://github.com/verekia/js-stack-from-scratch#table-of-contents).
