...
Next section: [4 - Using the ES6 syntax with a class](/tutorial/04-es6-syntax-class)

Back to the [previous section](/tutorial/02-packages) or the [table of contents](https://github.com/verekia/js-stack-from-scratch).
