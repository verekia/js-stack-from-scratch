...
ESLint работи с набор от *правила*. [Тук ще намерите списък с тези правила](http://eslint.org/docs/rules/). Вместо да конфигурираме тези, които искаме да използваме в нашия код, ще използваме конфигурация създадена от Airbnb. Тази конфигурация използва няколко плъгина, така че ще трябва да ги инсталираме и тях.
