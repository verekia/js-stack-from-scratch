...
ESLint работи с *правила*. [Тук ще намерите спинсък с тези правила](http://eslint.org/docs/rules/). Вместо да конфигурираме правилата, които искаме да използваме в нашия код, ще използваме конфигурацията създадена от Airbnb. Тази конфигурация използва няколко плъгина, така че ще трябва да ги инсталираме и тях.
