...
Next section: [7 - Client app with Webpack](/tutorial/07-client-webpack)

Back to the [previous section](/tutorial/05-es6-modules-syntax) or the [table of contents](https://github.com/verekia/js-stack-from-scratch).
