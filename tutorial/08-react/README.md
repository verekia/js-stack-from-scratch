...
Next section: [9 - Redux](/tutorial/09-redux)

Back to the [previous section](/tutorial/07-client-webpack) or the [table of contents](https://github.com/verekia/js-stack-from-scratch).
